...
# Lab 1: C++语法基础 ([报告模版下载](https://znas.cn/AppH5/share/?nid=KEYDEMJQGA2DCRKHGJBTS&code=dXSEbu4VuyyAHjGMBTKPCeksCbTCm3bm3Jki4SC3jSXvQOBiht9hHyGXvZ2y0a9xLi&mode=file&display=list))
{: .no_toc }
...
- Q1 和 Q2 均会设置 3 个测试用例，每个测试用例占该题目分值的 30%，剩下 10% 主要根据代码风格以及命名规范进行打分。